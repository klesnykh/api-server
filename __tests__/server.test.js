...
describe('Testing CRUD on clothes route', () => {
  test('Should respond with a 200 if new clothes record created', async () => {
    const response = await request.post('/clothes?name=jeans').send({name: 'jeans', on: true});
